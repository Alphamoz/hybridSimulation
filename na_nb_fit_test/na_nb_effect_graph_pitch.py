...
data = pd.read_csv('mse_values_train_pitch.csv')
...
surf = ax.plot_surface(na_mesh, nb_mesh, pitch_values, cmap='viridis', edgecolor='none')
...
ax.set_xlabel('nb')
ax.set_ylabel('na')
ax.set_zlabel('MSE_pitch')
ax.set_title('MSE Pitch for Different na, nb in Data Training', fontweight="bold")
