...
data = pd.read_csv('mse_values_train_depth_rate.csv')

# Extracting the columns from the data
na = data['na']
nb = data['nb']
MSE_depthrate = data['MSE_depthrate']
...
surf = ax.plot_surface(na_mesh, nb_mesh, depthrate_values, cmap='Set2', edgecolor='none')
...
ax.set_title('MSE Depth Rate for Different na, nb on Data Training', fontweight="bold")
