...
publisher_be = rospy.Publisher("/desired_internal_volume", Float32, queue_size=10)
rospy.Subscriber("/gather_gui", Gui, update_current_state)
...
file_path = "simulation_data_MPCnoDisturbance{}{}.npz".format(
    depthrateinit, prediction_horizon)
...
np.savez(file_path, depth_sim=depth_sim, pitch_angle_sim=pitch_angle_sim,
         ...
         setpointpitch_angle_sim=pitch_angle.SP, setpointdepth_sim=depth.SP)
