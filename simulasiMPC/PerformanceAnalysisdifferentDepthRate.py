...
for i,ctrlhor in [[100,4],[200,4],[300,4]]:
    ...
    print("Depth for {}".format(i), settling_time_depth, rise_time_depth, energy, os, steady_error)
    ...
    print("Pitch for {}".format(i),settling_time_pitch, rise_time_depth, energy, os, steady_error)
    ...
    print("Depth Rate for {}".format(i),settling_time_pitch, rise_time_depth, energy, os,steady_error)
